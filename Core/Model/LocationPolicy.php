 ...
 */
class LocationPolicy extends \Magento\Framework\Model\AbstractModel implements LocationPolicyInterface, IdentityInterface
{

    const CACHE_TAG = UpgradeSchema::TABLE_BECKN_LOCATION_POLICY;

    protected $_cacheTag = UpgradeSchema::TABLE_BECKN_LOCATION_POLICY;

    protected $_eventPrefix = UpgradeSchema::TABLE_BECKN_LOCATION_POLICY;
    ...
    protected function _construct(){
        $this->_init(ResourceModelLocationPolicy::class);
    }
    ...
    public function getRequestBody(){
        /**
         * @var \Beckn\Core\Model\ResourceModel\PolicyRequest\Collection $collection
         */
        $collection = $this->_requestBodyCollectionFactory->create();
        $collection->addFieldToFilter(PolicyRequestInterface::POLICY_TYPE, PolicyType::POLICY_TYPE['location_policy']);
